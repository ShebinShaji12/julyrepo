...
public class trivagodatepicker {
	...
	public void datepicker() throws Exception
	{
		...
		driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[2]/section[1]/div[2]/div[4]/div/div/fieldset/button[1]/span/span[2]/span[2]")).click();
		datepickermethod("November 2024","2");
	}
		private void datepickermethod(String expmonth,String expdate) {
			while(true) {
				...
				List<WebElement> date=driver.findElements(By.xpath("//*[@id=\"__next\"]/div[1]/div[2]/section/div[2]/div/div[4]/div/div[2]/div/div/div/div[2]/div/div[2]/div[2]/button[7]/time"));
